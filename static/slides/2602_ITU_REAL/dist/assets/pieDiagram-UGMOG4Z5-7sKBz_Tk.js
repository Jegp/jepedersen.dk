import{p as U}from"./chunk-WASTHULE-BCH30SW9.js";import{p as H}from"./treemap-KZPCXAKY-L5K4MMMF-DyhwgAVt.js";import{g as Q,s as V,a as Z,b as j,v as q,t as J,_ as s,l as w,c as K,H as X,aO as Y,aP as ee,aQ as G,aR as te,e as ae,B as re,aS as ie,I as se}from"./md-gUc9MlRX.js";import"./chunk-MFRUYFWM-D2ZuGyXt.js";import"./index-CWzMwBwX.js";import"./modules/vue-DnQjUCi8.js";import"./modules/shiki-CX5LEMOY.js";import"./slidev/VClicks-izTIe6x7.js";import"./slidev/context-CHxnpE0F.js";import"./modules/file-saver-B7oFTzqn.js";import"./slidev/default-DPN9CXcb.js";var le=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),O={getConfig:ne,clear:ce,setDiagramTitle:J,getDiagramTitle:q,setAccTitle:j,getAccTitle:Z,setAccDescription:V,getAccDescription:Q,addSection:pe,getSections:de,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),me={parse:s(async e=>{const a=await H("pie",e);w.debug(a),fe(a,O)},"parse")},he=s(e=>`
  .pieCircle{
